...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => 'checkRole:superadmin,kepala gudang,admin gudang,staff warehouse'], function(){
    ...
    Route::group(['middleware' => 'checkRole:superadmin,staff warehouse'], function(){
